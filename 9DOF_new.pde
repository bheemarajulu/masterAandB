...
void setup()
{
 ...
 altSerial.begin(38400);
  ...
  altSerial.print("LSM9DS0 WHO_AM_I's returned: 0x");
  altSerial.println(status, HEX);
  altSerial.println("Should be 0x49D4");
  altSerial.println();
  altSerial.print("I AM");
  altSerial.print(status, HEX);
  altSerial.print("I Should Be");
  altSerial.print(0x49D4, HEX);   
  delay(2000); 
...
void loop()
{
  ...
  if(digitalRead(INT2XM)) {  // When new magnetometer data is ready
    ...
    //altSerial.print("mx1 = "); altSerial.print( (int)1000*mx); 
    //altSerial.print(" my1 = "); altSerial.print( (int)1000*my); 
    //altSerial.print(" mz1 = "); altSerial.print( (int)1000*mz); altSerial.println(" mG");
  ...
  if (ax < AccelMinX) AccelMinX = ax;
  if (ax > AccelMaxX) AccelMaxX = ax;
  
  if (ay < AccelMinY) AccelMinY = ay;
  if (ay > AccelMaxY) AccelMaxY = ay;
 
  if (az < AccelMinZ) AccelMinZ = az;
  if (az > AccelMaxZ) AccelMaxZ = az;
  ...
  // For more see http://en.wikipedia.org/wiki/Conversion_between_quaternions_and_Euler_angles which has additional links.
    ...
    if(yaw<yawMinX) yawMinX = yaw;
    if(yaw>yawMaxX) yawMaxX = yaw;
    
    if(pitch<pitchMinY) pitchMinY = pitch;
    if(pitch>pitchMaxY) pitchMaxY = pitch;
    
    if(roll<rollMinZ) rollMinZ = roll;
    if(roll>rollMaxZ) rollMaxZ = roll;

    

    altSerial.print("ax = "); altSerial.print((int)1000*ax);  
    altSerial.print(" ay = "); altSerial.print((int)1000*ay); 
    altSerial.print(" az = "); altSerial.print((int)1000*az); altSerial.println(" mg");
    altSerial.print("gx = "); altSerial.print( gx, 2); 
    altSerial.print(" gy = "); altSerial.print( gy, 2); 
    altSerial.print(" gz = "); altSerial.print( gz, 2); altSerial.println(" deg/s");
    altSerial.print("mx = "); altSerial.print( (int)1000*mx); 
    altSerial.print(" my = "); altSerial.print( (int)1000*my); 
    altSerial.print(" mz = "); altSerial.print( (int)1000*mz); altSerial.println(" mG");
    
    altSerial.print("temperature = "); altSerial.println(temperature, 2);
    
    altSerial.print("Yaw, Pitch, Roll: ");
    altSerial.print(yaw, 2);
    altSerial.print(", ");
    altSerial.print(pitch, 2);
    altSerial.print(", ");
    altSerial.println(roll, 2);
    
    altSerial.print(F("Orientation: "));
    altSerial.print(roll,2);
    altSerial.print(F(" "));
    altSerial.print(pitch,2);
    altSerial.print(F(" "));
    altSerial.print(yaw,2);
    ...
    altSerial.print("q0 = "); altSerial.print(q[0]);
    altSerial.print(" qx = "); altSerial.print(q[1]); 
    altSerial.print(" qy = "); altSerial.print(q[2]); 
    altSerial.print(" qz = "); altSerial.println(q[3]); 
    
    altSerial.print("filter rate = "); altSerial.println(1.0f/deltat, 1);
...
void printHeading(float hx, float hy)
{
  if (hy > 0)
  {
    heading = 90 - (atan(hx / hy) * (360 / PI));
  }
  else if (hy < 0)
  {
    heading = - (atan(hx / hy) * (360 / PI));
  }
  else // hy = 0
  {
    if (hx < 0) heading = 360;
  ...
  altSerial.print("Heading: ");
  altSerial.println(heading, 2);
}
